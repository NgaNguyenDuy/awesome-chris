...
clock_m = {
    ...
    graph_fg_colour=0xFFFFFF,      graph_fg_alpha=0.0,
    txt_radius=100,
    txt_weight=1,                  txt_size=5.0,
    txt_fg_colour=0xFFFFFF,        txt_fg_alpha=0.0,
    graduation_radius=94,
...
clock_c = {
    ...
    graduation_thickness=2,        graduation_mark_thickness=0.5,
    graduation_unit_angle=0.25,
    graduation_fg_colour=0x000000, graduation_fg_alpha=0.6,
    },
...
function go_clock_rings(display)
    ...
    for i in pairs(clock_m) do
     ...
     for i in pairs(clock_c) do
        load_clock_rings(display, clock_c[i])
    end
end
